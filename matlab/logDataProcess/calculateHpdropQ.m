function [tt,icT,hpdrop,v12,dqp,v122,hv,res,hva,hvb,hqpa,hqpb,resa,resb,hv0,hqp0,res0,ql,...
    hqp0sse,res0sse,icTsse] = calculateHpdropQ(pdata,isDC,efficiency,temp1,temp2)
%coreT', inT', outT', ql', qf', hp', v1', v2', v3',qPow', 
...
for ti = 1:numel(uniqCT) 
  ...
  %find hp0 where simulated power = 0;
  %for each temperature, there is only one hp0
