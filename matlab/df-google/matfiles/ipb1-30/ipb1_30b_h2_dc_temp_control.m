...
experiment_name = 'ipb1-30b-h2-dc-temp-control.csv';
matfile = strcat(containing_dir, filesep, ...
  strrep(experiment_name, '.csv', '.mat'));
parameter_file = 'ipb1-30b-h2-dc-calibration_DKF_calibration.05.mat';
calibration_file = 'ipb1-30b-h2-dc-calibration_DKF_calibration.05.mat';
