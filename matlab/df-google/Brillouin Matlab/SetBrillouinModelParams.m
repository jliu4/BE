...
lpf = ~isempty(strfind(model_type, 'LPF'));
...
if lpf
  % the state also includes the delayed power
  varLabels.StateName = [varLabels.StateName, 'P_delayed'];
  varLabels.StateUnit = [varLabels.StateUnit, 'Watts'];
end
