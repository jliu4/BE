...
%reactor='sri-ipb2-27b-1216';
reactor='ipb3-32b-h2-121916';
%reactor='ipb3-32b-he-120516';
%reactor='ipb3-32b-he-121416';
%reactor='ipb3-36b';
switch (reactor)
case 'google' 
...
%asignColumn name
%j1(isnan(j1)) = -2 ;
%j1 = j1(j1(:,2) > 0,:); %only process data with seq
j1Size = size(j1,1);
