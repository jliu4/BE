...
run_data = AddDataPath(splitpath);
%% Load data (from *.mat or *.tdms as neccesary)
experiment_name = 'ipb3-32b-12302016.csv';

% define data import
map.headers = {'CoreTemp',  'InnerTemp', 'OuterTemp',...
                'QPulseLength', 'QPulseFreq',...
               'HeaterPower', 'CoreQPow'...
               'V1RMS', 'V2RMS', 'QPow','QSupplyPow','QSupplyVolt','QCur'...
               };
map.names   = map.headers
map.units   = {'Celsius', 'Celsius', 'Celsius',...
              'ns','kHz',...
               'Watts',  'Watts', ...
               'Celsius', ...
               'Celsius', 'Celsius', ...
