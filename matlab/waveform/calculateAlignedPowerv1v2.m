function [P,c,riseTime,v1,v2,v3,alignV,dvdt,riseTime12,dvdt12,j12]  = calculateAlignedPowerv1v2(fstMax,M,MM,delta,alignP,zterm,timeInterval,s2ns,coreL,inchNs,debug,tt,pi,mVolt)
   v1 = 0;
   v2 = 0;
   v3 = 0;
   %align up   
...
%   iv3=int32(v3); 
   ...
   while isempty(j12)
       reduceP = 0.1*i;
       i=i+1;
    j12 = find(signM*v12 > (0.9-reduceP)*signM*M(ifstMax,2),1,'first');
