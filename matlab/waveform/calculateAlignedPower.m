function [P,c,riseTime,v1s,v2s,v3s,alignV]  = calculateAlignedPower(fstMax,M,MM,delta,alignP,zterm,timeInterval,s2ns,coreL,inchNs)
   v1s = 0;
   v2s = 0;
   v3s = 0;
   %align up   
   ...
   %v1,v2,v3
   riseTime = (delta-v1s) * timeInterval*s2ns;
   v2s = v2-v1s;
