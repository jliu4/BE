...
%sri-ipb2
reactor ='ipb1-2016-09-29-CRIO-v170_CORE_29b' 
switch (reactor)
case 'ipb1-2016-09-29-CRIO-v170_CORE_29b' 
Directory='C:\Users\Owner\Dropbox (BEC)\ISOPERIBOLIC_DATA\2016-09-29-CRIO-v170_CORE_29b'
AllFiles = getall(Directory);  %SORTED BY DATE....
whichDate = '09302016';
switch (whichDate)
  case '09302016' 
    dataFile ='\ISOPERIBOLIC_DATA\2016-09-29-CRIO-v170_CORE_29b\IPB1_Core_29b-He-DC_QFLOW_CAL-9-29_16_day-01.csv : 02.csv'   
    startTime = 0;
    endTime = 0; 
...
figure(2)
hold on
aa_splot(dt,smooth(j1(:,11),11),'black');
%ylim([0 80])
...
delete(fn);
T=table(temp(:),ql(:),qf(:),hp(:),coreQPow(:),qPow(:),qPCB(:),qTerm(:),cjp(:),coreQPowCV(:),qPowCV(:),qPCBCV(:),qTermCV(:),cjpCV(:),dt2(:),...
'VariableName',{'Temp','QL','QF','HP','CoreQPower','qPow','qPCB','qTerm','CJP','coreQPowCV','qPowCV','qPCBCV','qTermCV','cjpCV','date'});
writetable(T,fn);
end
